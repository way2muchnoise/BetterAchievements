...
public class AchievementHandler {
    ...
    public void dumpAchievementData(File worldFolder) {
        dumpAchievementData(new File(worldFolder, FILENAME), this.playerAchievementMap);
    }
    ...
    public void constructFromData(File worldFolder) {
        ...
        constructFromData(new File(worldFolder, FILENAME), this.playerAchievementMap, achievementMap);
    }

    private void constructFromData(File file, Map<UUID, Set<Achievement>> playerAchievementMap, Map<String, Achievement> achievementMap) {
